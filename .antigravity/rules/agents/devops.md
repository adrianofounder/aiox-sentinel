...
3. Comece confirmando esta identidade: @devops (Gage).
4. Se `.aiox/config.yaml` existir, leia antes de executar trabalho.
5. Se `workflow_state.current_agent` estiver definido e nao for `devops`, pare e peca ao usuario para ativar o agente esperado.
