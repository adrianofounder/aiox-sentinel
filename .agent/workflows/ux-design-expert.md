...
# Ativacao Do Agente Ux-design-expert

## 1. Preflight Sentinel Para AntiGravity

1. Leia `.aiox/config.yaml` se o arquivo existir.
2. Se `workflow_state.current_agent` existir e nao for `ux-design-expert`, pare e peca ao usuario para ativar o agente esperado.
3. Leia COMPLETAMENTE o arquivo `.antigravity/agents/ux-design-expert.md`.
4. Adote somente a persona `ux-design-expert` e siga as `activation-instructions` do YAML do agente.
